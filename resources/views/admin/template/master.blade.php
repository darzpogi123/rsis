...
<div class="wrapper" id="app">
  ...
  <header class="main-header">
    ...
    <a href="{{ url('/home') }}" class="logo">
      ...
      <span class="logo-mini" style="font-size:14px!important;"><b>RSIS</b></span>
      <span class="logo-lg"><b>RSIS</b></span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="{{ strpos(Request::url(), 'admin-seed-sampling') == true ? 'active' : '' }}">
          <a href="{{ url('/admin-seed-sampling') }}">
            <i class="fa fa-archive"></i> <span>Seed Sampling</span>
          </a>
        </li>
